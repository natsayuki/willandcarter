<?php
  ...
  /* **************************************************
    USER VARIABLES
	************************************************** */
  $botId   = "f957f4b9bcd85302848c5c5ca3";
  ...
  if (iStr($p['name'],array('botname')) === false) { // This post wasn't made by the bot, so we'll continue (prevents infinite loop)
    ...
    if (iStr($text,array("will and carter’s funny skits subscribers", "will and carters funny skits subscribers", "how many subscribers does will and carter's funny skits have", "how many subscribers does will and carters funny skits have"))) {
